...
local function initializeSCScript()
    ...
    if trackLength >= 3500 then
        ...
        writeLog("SC: Longer track (" .. trackLength .. "), thresholds set to - start: " .. tostring(SC_CALLIN_THRESHOLD_START) " | end: " .. tostring(SC_CALLIN_THRESHOLD_END))
    end
end
